...
namespace Testes
{
    public class DataGenerator 
    {
        ...
        //    {
        //       new Coordinator { Id = 1, WorkerId = 1},
        //       new Coordinator { Id = 501, WorkerId = 200},
        //    };
        ...
        //       new Line { Id = 101, Name = "Linha101" , Priority = true, CoordinatorId = 500},
        //       new Line { Id = 102, Name = "Linha102" , Priority = true, CoordinatorId = 501},
        //    };
        ...
        //       //linha 22
        //       new Production_Plan { Id = 21, Goal = 100 ,Name = "Plano de produção 3", InitialDate = new DateTime(2023, 6, 28, 0, 0, 0)
        //       ,EndDate = DateTime.Now.AddDays(1), Shift = 1, ProductId = 200, LineId = 22},
        //       //linha 23
        //       new Production_Plan { Id = 22, Goal = 100 ,Name = "Plano de produção 4", InitialDate = new DateTime(2023, 6, 28, 0, 0, 0)
